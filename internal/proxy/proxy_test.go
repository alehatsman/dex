...
func newTestProxy(t *testing.T, upstream http.Handler) (*httptest.Server, *bytes.Buffer) {
	...
	front := httptest.NewServer(newProxyHandler(upURL, logger, &Stats{}, "", ToolDescFull, ModelRouteConfig{}, nil))
...
func TestAuthGate(t *testing.T) {
	...
	front := httptest.NewServer(newProxyHandler(upURL, logger, &Stats{}, token, ToolDescFull, ModelRouteConfig{}, nil))
	defer front.Close()
